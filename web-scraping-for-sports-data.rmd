...
Dynamic Web Scraping
  ...
  - Introduction to Advanced Selenium Topics
...
- **CSS (Cascading Style Sheets):** A stylesheets language used to **style** documents in markup language
...
## robots.txt
- Document that defines what is and what is not allowed to be scraped off a web page
